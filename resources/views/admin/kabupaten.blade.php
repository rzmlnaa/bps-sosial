...
@section('content')
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4">
        <div>
            <h2 class="fw-bold mb-1" style="color: var(--bps-orange);">Master Wilayah</h2>
            <p class="text-muted mb-0">Manajemen Wilayah</p>
        </div>
    </div>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.kabupaten.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_kabupaten" class="form-control" placeholder="Contoh: Kab. Sambas"
                                required>
                        </div>
