                                            ...
                                            <tr>
                                                                ...
                                                                <li class="mb-2 d-flex justify-content-between align-items-center bg-light p-2 rounded border-start border-4 border-orange perubahan-item"
                                                                    ...
                                                                    <div class="d-flex gap-1">
                                                                        ...
                                                                        <form action="{{ route('rh-perubahan.destroy', $rev->id) }}"
                                                                            ...
                                                                            @method('DELETE')
                                                                            <button type="button"
                                                                                class="btn btn-sm text-danger border-0 btn-delete" {{ $rev->details_count > 0 ? 'disabled' : '' }}
                                                                                title="{{ $rev->details_count > 0 ? 'Hapus semua rincian nilai dulu' : 'Hapus Header' }}">
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <button type="button"
                                                            class="btn btn-sm btn-outline-warning border-0 btn-edit-rh-tahun" {{ ($tahun->perubahanHeaders->count() > 0 || $tahun->perubahan_details_count > 0) ? 'disabled' : '' }}
                                                        ...
                                                        <form action="{{ route('rh-tahun.destroy', $tahun->id) }}" method="POST"
                                                            ...
                                                            @method('DELETE')
                                                            <button type="button"
                                                                class="btn btn-sm btn-outline-danger border-0 btn-delete" {{ ($tahun->perubahanHeaders->count() > 0 || $tahun->perubahan_details_count > 0) ? 'disabled' : '' }}
                                                                title="{{ ($tahun->perubahanHeaders->count() > 0 || $tahun->perubahan_details_count > 0) ? 'Hapus semua header/detail perubahan dulu' : 'Hapus Tahun' }}">
                                                                <i class="fas fa-trash-alt"></i>
                                                            </button>
                                                        </form>
                                                    </div>
