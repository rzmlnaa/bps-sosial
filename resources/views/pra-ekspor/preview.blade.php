...
@section('title', 'Tabel Hasil Ekspor - ' . $kabupaten->nama_kabupaten)
...
@section('content')
    <div class="container-fluid py-4 fade-in-up">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 btn-hide-print">
            <div>
                ...
                <div class="text-muted" style="font-size: 0.9rem;">
                    Wilayah: <strong>{{ $kabupaten->nama_kabupaten }}</strong> | Periode: Bulan {{ $displayBulanText }}
                    Tahun {{ $displayTahunText }}
                </div>
            </div>
            <div class="d-flex gap-2">
                <a href="{{ route('pra-ekspor.index', ['kabupaten_id' => $kabupaten->id, 'tahun' => $tahun, 'bulan' => $bulan]) }}"
                    class="btn btn-outline-secondary">
                    <i class="fas fa-arrow-left"></i> Kembali ke Kurasi
                </a>
                <a href="{{ route('pra-ekspor.export-excel', ['kabupaten_id' => $kabupaten->id, 'tahun' => $tahun, 'bulan' => $bulan]) }}"
        ...
        <div class="mb-4 p-3 rounded btn-hide-print"
            style="background: #f8fafc; border: 1px solid #e2e8f0; display: inline-block;">
            <div class="d-flex align-items-center gap-3">
                <span class="fw-bold" style="font-size: 0.9rem; color: #475569;"><i class="fas fa-filter me-1"></i> Filter
                    Tampilan Indikator:</span>
            ...
            <div class="text-muted mt-1" style="font-size: 0.75rem;">*Jika tidak ada yang dicentang, semua indikator akan
                ditampilkan.</div>
        </div>
        ...
        <div class="export-wrapper">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-5">
                                    ...
                                    Belum ada fenomena yang ditandai/dipilih untuk diekspor pada filter ini.
                                </td>
                            </tr>
                        @endforelse
            ...
            <div class="mt-4 text-muted" style="font-size: 0.8rem;">
                ...
                * Tabel ini dapat diekspor langsung ke Microsoft Excel dengan klik tombol Export Excel di atas.
            </div>
        </div>
    </div>
@endsection
...
@push('scripts')
    <script>
        function confirmExport(e, btn, year) {
            ...
            Swal.fire({
                title: `Apakah yakin export Rekap Fenomena Tahun ${year}?`,
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        ...
                        html: `Mohon tunggu sejenak (<b>${secondsLeft}</b> detik)...<br><small class="text-muted">Sedang memproses data Excel.</small>`,
                        ...
                        didOpen: () => {
                            ...
                            timerInterval = setInterval(() => {
                                ...
                                if (secondsLeft > 0) {
                                    ...
                                    Swal.getHtmlContainer().innerHTML = 'Hampir selesai, sedang mengemas file...<br><small class="text-muted">Sedang memproses data Excel.</small>';
                                }
                            }, 1000);
                        },
                        willClose: () => {
                    ...
                    fetch(url)
                        .then(response => {
                            ...
                            let filename = `Rekap_Fenomena_${year}.xlsx`;
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function applyFilter() {
                ...
                rows.forEach(row => {
                    ...
                    // Jika tidak ada checkbox yang dicentang, tampilkan semua baris
                    if (checkedValues.length === 0) {
                        row.style.display = '';
                        row.querySelector('.row-number').textContent = currentNo++;
                    } else {
                        // Jika kelompok baris ini ada di checkbox yang tercentang
